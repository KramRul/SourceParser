...
namespace SourceParser.BusinessLogicLevel.Services
{
    public class DocumentService : BaseService, IDocumentService
    {
        ...
        public async Task<ObservableCollection<DocumentMod>> GetDocumentsInfFromLinesUsingDecisionTree(List<string> lines)
        {
            ...
            documents = await PredictDocumentsInfoUsingNeuralNetwork(documents);
        ...
        private async Task<ObservableCollection<DocumentMod>> PredictDocumentsInfoUsingNeuralNetwork(ObservableCollection<DocumentMod> documents)
        {
            foreach (var document in documents)
            {
