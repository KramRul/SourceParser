using SourceParser.BusinessLogicLevel.Helpers.DecisionTree.Interfaces;
using System;
...
namespace SourceParser.BusinessLogicLevel.Helpers.DecisionTree
{
    public class Node
    ...
    public class DecisionTreeListBased : IDecisionTree
    {
        public int NumNodes { get; set; }
        public int NumClasses { get; set; }
        public List<Node> Tree { get; set; }

        public DecisionTreeListBased(int numNodes, int numClasses)
        {
            NumNodes = numNodes;
